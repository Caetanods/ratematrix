##' Calculates the effective dependence of a list of matrices.
##'
##' This funtion is not optimized to be called by the user.
##' @title Effective dependence.
...
##' @return numeric. Return a vector with the effective dependence index of the matrices.
##' @author Daniel S. Caetano, \email{caetanods1@@gmail.com}
effective.dep <- function(mat, burn=0.5, thin=1){
    ## Calculates the effective dependence of a list of matrices.
