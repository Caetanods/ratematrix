...
logLikPrunningFixedAnc <- function(tips_poly, nodes_poly, k, p, nodes, des, anc, names_anc, mapped_edge, R) {
...
runRatematrixPolytopeTipsOnlyMCMC <- function(X_poly, n_input_move, k, p, nodes, des, anc, names_anc, mapped_edge, R, sd, Rcorr, w_sd, par_prior_sd, den_sd, nu, sigma, v, log_file, mcmc_file, poly_file, prob_proposals, gen, post_seq, write_header, max_branch_update, w_branch_sd, sd_file, verbose) {
    .Call('_ratematrix_runRatematrixPolytopeTipsOnlyMCMC', PACKAGE = 'ratematrix', X_poly, n_input_move, k, p, nodes, des, anc, names_anc, mapped_edge, R, sd, Rcorr, w_sd, par_prior_sd, den_sd, nu, sigma, v, log_file, mcmc_file, poly_file, prob_proposals, gen, post_seq, write_header, max_branch_update, w_branch_sd, sd_file, verbose)
}
