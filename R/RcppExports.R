...
logLikPrunningFixedAnc <- function(tips_poly, nodes_poly, k, p, nodes, des, anc, names_anc, mapped_edge, R, root) {
    .Call('_ratematrix_logLikPrunningFixedAnc', PACKAGE = 'ratematrix', tips_poly, nodes_poly, k, p, nodes, des, anc, names_anc, mapped_edge, R, root)
}

runRatematrixPolytopeMCMC <- function(X_poly, anc_poly, n_input_move, k, p, nodes, des, anc, names_anc, mapped_edge, R, root, w_mu, par_prior_mu, den_mu, sd, Rcorr, w_sd, par_prior_sd, den_sd, nu, sigma, v, log_file, mcmc_file, poly_file, prob_proposals, gen, post_seq, write_header) {
    .Call('_ratematrix_runRatematrixPolytopeMCMC', PACKAGE = 'ratematrix', X_poly, anc_poly, n_input_move, k, p, nodes, des, anc, names_anc, mapped_edge, R, root, w_mu, par_prior_mu, den_mu, sd, Rcorr, w_sd, par_prior_sd, den_sd, nu, sigma, v, log_file, mcmc_file, poly_file, prob_proposals, gen, post_seq, write_header)
}
